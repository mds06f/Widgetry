...
const LOCAL_FALLBACKS = {
  'dad-jokes': [
    ...
    { text: "Why do fathers take an extra pair of socks when they go golfing?", punchline: "In case they get a hole in one!" },
    { text: "Did you hear about the restaurant on the moon?", punchline: "Great food, no atmosphere." },
    { text: "What do you call a factory that makes okay products?", punchline: "A satisfactory." },
    { text: "Dear Math, grow up and solve your own problems." }
  ],
  'programming': [
    { text: "Why do programmers wear glasses?", punchline: "Because they need to C#." },
    { text: "There are 10 types of people in the world: those who understand binary, and those who don't." },
    { text: "How many programmers does it take to change a light bulb?", punchline: "None, that's a hardware problem." },
    { text: "['hip', 'hip']", punchline: "hip hip array!" },
    { text: "A SQL query goes into a bar, walks up to two tables and asks:", punchline: "'Can I join you?'" }
  ],
  'general': [
    { text: "The primary flight feathers of a bird are called remiges.", punchline: "True" },
    { text: "The total surface area of two human lungs is approximately 70 square meters.", punchline: "True" },
    { text: "Sound travels faster in water than in air.", punchline: "True" },
    { text: "A day on Venus is longer than a year on Venus.", punchline: "True" },
    { text: "The heart of a shrimp is located in its head.", punchline: "True" }
  ]
};
        ...
        .then(data => {
          if (data && data.results && data.results.length > 0) {
            ...
            const decodedQuestion = item.question
              ...
              .replace(/&#039;/g, "'")
              .replace(/&amp;/g, '&');
            setContent({ text: decodedQuestion, punchline: `Answer: ${item.correct_answer}` });
            setLoading(false);
          } else {
            useFallback();
          }
          ...
          <div style={{
            ...
            {content.punchline && (
              <div style={{ minHeight: '40px', display: 'flex', alignItems: 'center' }}>
                {revealed ? (
                  <p className="trivia-punchline" style={{
                    fontSize: '0.95rem',
                    fontWeight: '700',
                    margin: '0',
                    color: textColor,
            ...
            <button
              ...
              onMouseOut={(e) => { e.target.style.opacity = '0.8'; e.target.style.background = 'transparent'; }}
            >
              Next ➔
            </button>
          </div>
