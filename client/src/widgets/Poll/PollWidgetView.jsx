...
export default function PollWidgetView({ config = {} }) {
  ...
  return (
    <>
      ...
      >
        <h3 style={{ margin: "0 0 16px", fontSize: "18px", fontWeight: "600" }}>{question}</h3>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  padding: "10px 14px",
                  borderRadius: "8px",
                  border: isVoted ? "2px solid #6366f1" : "1px solid rgba(255, 255, 255, 0.2)",
              ...
              >
                ...
                <div
                  style={{
                    ...
                    bottom: 0,
                    width: `${pct}%`,
                    backgroundColor: isVoted ? "rgba(99, 102, 241, 0.4)" : "rgba(255, 255, 255, 0.15)",
                    transition: "width 0.3s ease",
                    zIndex: 0,
                  }}
                />

                <span style={{ zIndex: 1, fontSize: "14px", fontWeight: "500" }}>{option}</span>
                <span style={{ zIndex: 1, fontSize: "12px", opacity: 0.8 }}>{pct}%</span>
              </div>
            );
          })}
        </div>

        <div style={{ fontSize: "12px", opacity: 0.7, textAlign: "right", marginTop: "12px" }}>
