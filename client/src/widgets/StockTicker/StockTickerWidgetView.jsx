    ...
    <>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <h2 style={{ margin: 0, fontSize: "24px", fontWeight: "700" }}>{symbol}</h2>
            <p style={{ margin: "2px 0 0", fontSize: "12px", opacity: 0.7 }}>{companyName}</p>
          </div>
          <span
            style={{
              padding: "4px 8px",
        ...
        <div style={{ margin: "16px 0" }}>
          <span style={{ fontSize: "32px", fontWeight: "bold" }}>${basePrice}</span>
        </div>
